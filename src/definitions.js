            ...
            <div className="grid-x">
                <div className="medium-10 medium-offset-1">
                    <div className="definitions__header">
                        <span className="h3 definitions__heading">About the data</span>
                        <a href="https://opendata.arcgis.com/datasets/98a09bec89c84681ae1701a2eb62f599_0.csv" className="button definitions__download-button">Download the data</a>
                    </div>
